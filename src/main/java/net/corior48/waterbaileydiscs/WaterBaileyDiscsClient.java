...
public class WaterBaileyDiscsClient {
    public WaterBaileyDiscsClient(ModContainer container) {
    ...
    static void onClientSetup(FMLClientSetupEvent event) {
        ...
        WaterBaileyDiscs.LOGGER.info("HELLO FROM CLIENT SETUP");
        WaterBaileyDiscs.LOGGER.info("MINECRAFT NAME >> {}", Minecraft.getInstance().getUser().getName());
    }
}
